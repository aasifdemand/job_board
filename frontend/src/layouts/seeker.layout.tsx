...
import SeekerSidebar from "@/components/shared/seeker-sidebar";
    ...
    <SidebarProvider>
      <div className="flex min-h-screen w-full bg-background">
        ...
        <div className="flex flex-col flex-1 w-full overflow-hidden">
          {/* Header */}
          <header className="sticky top-0 z-40 h-18 border-b bg-background/95 backdrop-blur supports-backdrop-filter:bg-background/60 flex items-center gap-4 px-6">
          ...
          <footer className="border-t px-6 py-4 bg-card/50">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
              <div className="flex items-center gap-2">
                ...
                <span>
                  © {new Date().getFullYear()} JobGeek. Connecting talent with
                  opportunity.
                </span>
              </div>
